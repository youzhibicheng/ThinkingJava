...
public class DoubleArraySeq implements Cloneable
{
   ...
   **/
   ...
   {
      // Implemented by student.
	  //implemented by JAMES ZOU
	   if( this.manyItems >= data.length ){
		   this.ensureCapacity(this.manyItems + 1 );
	   }
//	   double[] arr = new double[manyItems - currentIndex];
//	   System.arraycopy(data, currentIndex, arr, 0, arr.length );
//	   data[currentIndex++] = element;
//	   System.arraycopy(arr, 0, data, currentIndex, arr.length );
//	   manyItems++;
