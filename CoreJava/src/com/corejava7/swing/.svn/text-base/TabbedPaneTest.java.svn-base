...
{  
   ...
   {  
      ...
      ImageIcon icon = new ImageIcon("src\\com\\thinking\\swing\\yellow-ball.gif");
   ...
   */
   private void loadTab(int n)
   {
      ...
      ImageIcon planetIcon = new ImageIcon("src\\com\\thinking\\swing\\"+title + ".gif");
      tabbedPane.setComponentAt(n, new JLabel(planetIcon));
      
      // indicate that this tab has been visited--just for fun
      
      tabbedPane.setIconAt(n, new ImageIcon("src\\com\\thinking\\swing\\red-ball.gif"));
   }
