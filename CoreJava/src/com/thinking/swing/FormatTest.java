...
{  
   ...
   {  
      ...
      //恢复显示以匹配 getValue，这可能丢失当前的编辑内容。
      //JFormattedTextField.COMMIT 
      //提交当前值。如果 AbstractFormatter 不认为所编辑的值是合法值，则抛出 ParseException，然后不更改该值并保留已编辑的值。
      //JFormattedTextField.COMMIT_OR_REVERT 	
      //与 COMMIT 类似，但是如果该值不是合法的，则其行为类似于 REVERT。
      //JFormattedTextField.PERSIST 	
      //不执行任何操作，不获取新的 AbstractFormatter 也不更新该值。
