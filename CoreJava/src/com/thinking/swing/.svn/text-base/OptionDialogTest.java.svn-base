   ...
   */
   ...
   {  
      ...
      if (s.equals("String[]"))
         ...
         return new Icon[]
         {  
            new ImageIcon("src/com/thinking/swing/yellow-ball.gif"),
            new ImageIcon("src/com/thinking/swing/blue-ball.gif"),
            new ImageIcon("src/com/thinking/swing/red-ball.gif")
         };
      else if (s.equals("Object[]"))
         return new Object[]
         {  
