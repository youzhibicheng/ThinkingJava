...
{  
   public static void main(String[] args)
   {
      ...
      {  
         ...
         DataOutputStream out = new DataOutputStream(new FileOutputStream("src\\com\\thinking\\stream\\Employee2.dat"));
         for (Employee2 e : staff)
            e.writeData(out);
         out.close();
      
         // retrieve all records into a new array
         RandomAccessFile in = new RandomAccessFile("src\\com\\thinking\\stream\\Employee2.dat", "r");   
